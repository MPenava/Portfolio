...
export const H1 = createComponent<HTMLHeadingElement>(
  "h1",
  "scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl break-words hyphens-auto",
  "H1",
);

export const H2 = createComponent<HTMLHeadingElement>(
  "h2",
  "scroll-m-20 py-2 text-3xl font-semibold tracking-tight first:mt-0 break-words hyphens-auto",
  "H2",
);
...
export const P = createComponent<HTMLParagraphElement>("p", "leading-6", "P");
